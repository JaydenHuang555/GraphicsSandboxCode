...
public class SpanishVideo extends JPanel implements MouseListener, MouseMotionListener, KeyListener, ActionListener {
    ...
    private final List<Stick> sceneSticks = new ArrayList<>();
    private List<Stick> savedSticks = new ArrayList<>();
...
//    private static final long FADE_IN_DURATION_NS = 60 * 2;
    ...
    public final String title = "Territorio Shuar";
...
//            "Territorio Shuar",
            ...
            "Editor: Ruben O",
            "Animadora: Jayden H",
            "Inspiración Musical: Hotel California por Eagles",
            "Muchas Gracias: Ruben por darme la idea.",
            "Programa de Gráficos: hecho por Jayden ",
            "Código Fuente: https://github.com/JaydenHuang555/GraphicsSandboxCode"
    };
...
//            "Territorio Shuar",
    ...
    public SpanishVideo() {
        try {
            background = ImageIO.read(new File("jungle.jpg"));
            stopWatchTime = System.nanoTime();
        } catch (IOException e) {
            System.out.println("Could not load jungle.jpg");
        }
...
//            savedSticks.clear();
    ...
    public void startFifthScene() {
        ...
        sceneSticks.add(jose);
        jose.mood = "happy";
        sceneSticks.add(new EmiliaStick(339, 183, "happy"));
        timer.start();
